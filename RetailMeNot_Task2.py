...
goodDeals = open("RetailMeNotGoodDeals.txt", "r")
...
numberOfTopics = 4  ## Number of topics we want to estimate ##
lda = models.LdaModel(corpusTfidf, id2word=dictionary, num_topics=numberOfTopics)

for i in range(0, numberOfTopics):
    temp = lda.show_topic(i, 5)## to find 5 most contributing words to the topic ##
    terms = []
    for term in temp:
        terms.append(term[1])
